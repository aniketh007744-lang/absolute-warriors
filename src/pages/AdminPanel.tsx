...
export default function AdminPanel() {
  ...
  useEffect(() => {
    Promise.all([
      fetch("https://absolute-warriors-backend-1.onrender.com/admin/users").then(res => res.json()),
      fetch("https://absolute-warriors-backend-1.onrender.com/admin/leads").then(res => res.json())
    ])
